...
Status: deployed and verified for the configured work roots. Physical Android voice acceptance remains pending, but it is not the authority source for desktop execution.
